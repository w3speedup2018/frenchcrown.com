       ...
       */
            ...
            value: function _updateAddToCartButton(newVariant) {
              ...
              if (!newVariant) {
                ...
                if(meta.product.product_type != 'Suit' && meta.product.product_type != 'Trenchcoat Suit'){
...
//                   }
          ...
          }else if(meta.product.product_type == 'Suit' || meta.product.product_type == 'Trenchcoat Suit'){
            var pant_size = '';
          	$('.ProductForm__Item').each(function(index){
