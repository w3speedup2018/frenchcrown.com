! function(t) {
    ...
    setTimeout(function() {
        ...
        var e = new h.a(window.navigator.userAgent),
            ...
            o = new c.a(r),
            s = new p.a("RDYLCIM5Y155SWZQGILHCUEP", "M4XQPUTKFX43397M8GQZJFM5"),
            l = new i.a({
                el: "#searchModalContainer",
                data: {
                    collectionID: "MA5Z99AGPMHHHDF373DF2VCQ",
                    query: "",
                ...
                methods: {
                    ...
                    init: function() {
                        ...
                        if (e.includes("/search?") && "https://frenchcrown.com" === window.location.origin) {
